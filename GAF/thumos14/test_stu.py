...
from GAF.thumos14.BDNet_student import BDNet_student as BDNet
...
rgb_checkpoint_path = config['testing'].get('rgb_checkpoint_path',
                                            './models/thumos14/35_300/checkpoint-16.ckpt')
flow_checkpoint_path = config['testing'].get('flow_checkpoint_path',
                                             './models/thumos14_flow/1e3_flow/checkpoint-16.ckpt')
...
if __name__ == '__main__':
    ...
    if fusion:
        ...
        flow_net.load_state_dict(torch.load(
            flow_checkpoint_path), strict=False)
        rgb_net.eval().cuda()
        flow_net.eval().cuda()
        net = rgb_net
